...
public extension Layout {
    ...
    @discardableResult public func fill(_ edge: SidedLayoutItem<LayoutRegion, YAxis>, _ insets: UIEdgeInsets = UIEdgeInsets.zero) ->
    (edgeConstraint: NSLayoutConstraint,
     ...
     rightConstraint: NSLayoutConstraint) {
        ...
        let leftConstraint = (base.left == edge.layoutItem.item.left + insets.left)
        let rightConstraint = (base.right == edge.layoutItem.item.right - insets.right)
    ...
    @discardableResult public func fill(_ edge: SidedLayoutItem<LayoutRegion, XAxis>, _ insets: UIEdgeInsets = UIEdgeInsets.zero) ->
    (edgeConstraint: NSLayoutConstraint,
     ...
     bottomConstraint: NSLayoutConstraint) {
        ...
        let topConstraint = (base.top == edge.layoutItem.item.top + insets.top)
        let bottomConstraint = (base.bottom == edge.layoutItem.item.bottom - insets.bottom)
